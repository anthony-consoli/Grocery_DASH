...
GameText::GameText()
{
	...
	gameTextToDraw = new vector<TextToDraw*>();
	settingsTextToDraw = new vector<TextToDraw*>();
	itemListTextToDraw = new vector<TextToDraw*>();
	statsTextToDraw = new vector<TextToDraw*>();
}
...
/*
	...
	be added once.
*/
void GameText::addText(wstring *textToAdd, int initX, int initY, int initWidth, int initHeight)
{
...
void GameText::addGameText(wstring *textToAdd, int initX, int initY, int initWidth, int initHeight)
{
	TextToDraw *text = new TextToDraw();
	text->setText(textToAdd);
	text->x = initX;
	...
	text->width = initWidth;
	text->height = initHeight;
	gameTextToDraw->push_back(text);
}

void GameText::addSettingsText(wstring *textToAdd, int initX, int initY, int initWidth, int initHeight){
	TextToDraw *text = new TextToDraw();
	text->setText(textToAdd);
	text->x = initX;
	text->y = initY;
	text->width = initWidth;
	text->height = initHeight;
	settingsTextToDraw->push_back(text);
}

void GameText::addInGameItemListText(wstring *textToAdd, int initX, int initY, int initWidth, int initHeight){
	TextToDraw *text = new TextToDraw();
	text->setText(textToAdd);
	text->x = initX;
	text->y = initY;
	text->width = initWidth;
	text->height = initHeight;
	itemListTextToDraw->push_back(text);
}

void GameText::addStatsText(wstring *textToAdd, int initX, int initY, int initWidth, int initHeight){
	TextToDraw *text = new TextToDraw();
	text->setText(textToAdd);
	text->x = initX;
	text->y = initY;
	text->width = initWidth;
	text->height = initHeight;
	statsTextToDraw->push_back(text);
}
...
void GameText::changeGameTextOnly(wstring *textToSet, int index)
{
	TextToDraw *textToChange = gameTextToDraw->at(index);
	wstring *oldText = textToChange->getText();
	delete oldText;
	textToChange->setText(textToSet);
}

void GameText::changeSettingsTextOnly(wstring *textToSet, int index)
{
	TextToDraw *textToChange = settingsTextToDraw->at(index);
	wstring *oldText = textToChange->getText();
	delete oldText;
	textToChange->setText(textToSet);
}

void GameText::changeInGameItemListTextOnly(wstring *textToSet, int index)
{
	TextToDraw *textToChange = itemListTextToDraw->at(index);
	wstring *oldText = textToChange->getText();
	delete oldText;
	textToChange->setText(textToSet);
}

void GameText::changeStatsTextOnly(wstring *textToSet, int index)
{
	TextToDraw *textToChange = statsTextToDraw->at(index);
	wstring *oldText = textToChange->getText();
	delete oldText;
	textToChange->setText(textToSet);
}
