...
enum GameState
{
	...
	// AT THE MAIN MENU, IF THE PLAYER CHOOSES THE 'START GAME' OPTION FROM THE
	// MAIN MENU, IT WILL BRING THE PLAYER TO THIS SCREEN TO SELECT THE LEVEL
	// HE WANTS TO PLAY
	GS_LEVEL_SELECT,

	// SHOWS THE PLAYER STATSITICS ABOUT HIS GAMEPLAY
	GS_STATS_SCREEN,

	// ALLOWS THE PLAYER TO EDIT CERTAIN GAMEPLAY SETTNGS
	GS_SETTINGS_SCREEN,

	// SHOWS THE PLAYER ACHIEVEMENTS MADE THROUGHOUT GAMEPLAY
	GS_ACHIEVEMENTS_SCREEN,
	...
	// WHILE THE GAME IS NOT OVER AND THE LOGIC NEEDS TO BE PROCESSED AND 
	// THE GAME WORLD NEEDS NO BE RENDERED, THE GAME WILL BE IN THIS STATE
	GS_GIP_SHELF_SCREEN_1, GS_GIP_SHELF_SCREEN_2,
	GS_GIP_SHELF_SCREEN_3, GS_GIP_SHELF_SCREEN_4,
	GS_GIP_SHELF_SCREEN_5, GS_GIP_SHELF_SCREEN_6,
	GS_GIP_SHELF_SCREEN_7, GS_GIP_SHELF_SCREEN_8,
	GS_GIP_SHELF_SCREEN_9, GS_GIP_SHELF_SCREEN_10,
	GS_GIP_SHELF_SCREEN_P1, GS_GIP_SHELF_SCREEN_P2,
